...
class SlidersControllerTest < ActionController::TestCase
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post :create, slider: { descriptiond: @slider.descriptiond, descriptiong: @slider.descriptiong, name: @slider.name, picture: @slider.picture }
    end
  ...
  test "should update slider" do
    patch :update, id: @slider, slider: { descriptiond: @slider.descriptiond, descriptiong: @slider.descriptiong, name: @slider.name, picture: @slider.picture }
    assert_redirected_to slider_path(assigns(:slider))
  end
