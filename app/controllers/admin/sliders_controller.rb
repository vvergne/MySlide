class Admin::SlidersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @slider.save
        format.html { redirect_to admin_slider_path(@slider), notice: 'Slider was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @slider.update(slider_params)
        format.html { redirect_to admin_slider_path(@slider), notice: 'Slider was successfully updated.' }
